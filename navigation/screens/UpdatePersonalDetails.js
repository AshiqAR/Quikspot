...
import { View, Text, TextInput, StyleSheet, Button, ScrollView, Pressable,Alert, Keyboard, KeyboardAvoidingView } from 'react-native';
        ...
        <View style={{flex:1}}>
            <ScrollView style={styles.container}>
                ...
                <TextInput
                    ...
                    onChangeText={(text) => setUserDetails({ ...userDetails, district: text })}
                />
