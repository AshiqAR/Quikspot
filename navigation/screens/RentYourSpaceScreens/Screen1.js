...
import { View, Text, TextInput, Pressable, StyleSheet, ScrollView, BackHandler, Alert } from 'react-native';
...
export default function Screen1({ navigation }) {
    ...
    const handleNextPress = () => {
        if (!parkAreaDetails.name || !parkAreaDetails.phone || !parkAreaDetails.email || !parkAreaDetails.address || !parkAreaDetails.city || !parkAreaDetails.district || !parkAreaDetails.state || !parkAreaDetails.pincode) {
