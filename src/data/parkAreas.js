const parkAreas = [
    {
        ...
        price_per_hr: 10,
        total_reviews: 11,
        exclusive_features: ['Free Wifi', 'Free Parking with fee *_*', 'Free Water', 'Free Food', 'Charging Stations', 'Secure Parking']
    },
    {
        name: 'City Park',
        area_id: 2,
        ...
        price_per_hr: 35,
        total_reviews: 2,
        exclusive_features: ['Free Wifi', 'Free Water', 'Free Food', 'Charging Stations', 'Secure Parking']
    },
    {
        name: 'Green Haven',
        area_id: 3,
    ...
    },
    {
        ...
        price_per_hr: 9,
        total_reviews: 13,
        exclusive_features: ['Free Wifi', 'Free Water', 'Charging Stations', 'Secure Parking']
    },
    {
        name: 'Sunset Valley',
        area_id: 5,
